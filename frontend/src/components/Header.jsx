        ...
        <header className="py-10 bg-indigo-600">
          <div className="container mx-auto flex flex-col lg:flex-row lg:px-4 justify-between items-center">
            ...
            <nav className="flex flex-col lg:flex-row gap-4 mt-5 lg:mt-0 items-center">
                <Link to="/" className="text-white text-xl uppercase hover:text-blue-400 hover:font-bold ">Pacientes</Link>
                <Link to="/admin/perfil" className="text-white text-xl uppercase hover:text-blue-400 hover:font-bold ">Perfil</Link>
